<?php
//ПЕРЕХОД С ОБРАБОТЧИКА ОТПРАВКИ ПИСЬМА АДМИНУ ДЛЯ ФОРМЫ ЗАКАЗА НАБОРА - ЗАЯВКА НЕ ПРИНЯТА ПИСЬМО НЕ ОТПРАВЛЕНО
...
<!DOCTYPE HTML>
 <html>
  <head>
    ...
    <![endif]-->
<title>Заказ набора - ошибка</title>
</head>
   ...
   <div id='message'>
    <h2 style="color:red;">Заявка не отправлена !</h2>
     <p style="color:red;">Во время отправки данных произошла ошибка ! Пожалуйста, попробуйте заполнить заявку еще раз.</p>
      <br/>
      <p><a href="index.php#top">Вернуться к регистрации заявки...</a></p>
