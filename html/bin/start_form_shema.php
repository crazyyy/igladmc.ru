<?php
//ƒЋя ќ“ѕ–ј¬ » ѕ»—№ћј јƒћ»Ќ” — ‘ќ–ћџ «ј ј«ј —’≈ћџ
...
session_start();
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// ------------------------------------  обработчик полей формы «ј ј«ј“№ ЌјЅќ–  ----------------------------------------------------- //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
// радиобутоны	 
    if ((isset($_POST['radiobutton']))) 
    {
	  $radio_value = ($_POST['radiobutton']);//присв перем -$radio_value- значение группы радиобутонов
		} else {$radio_value = '‘ормат не указан';}
// ѕрисваиваем значени¤м радиобутонов данные по форматам 
switch($radio_value)
{//ѕ–ќ’ќƒ»ћ ѕќ «Ќј„≈Ќ»яћ ѕ≈–≈ћ≈ЌЌќ… $radio_value
    case(1):
        // лидеры продаж
    ...
    break;		
    default:
        $radio = '‘ормат не указан';
}
// сесси¤ переменна¤ формат
...
if ((isset($_POST['adres2'])) && (strlen(trim($_POST['adres2'])) > 0)) 
    {
       ...
       $_SESSION['reg']['addres']  = $addres_us = $adres;    
        ...
        $subject = '–≈√»—“–ј÷»я «јя¬ » Ќј —’≈ћ”'; //пeременна¤ $subject формирует тему письма
        ...
        '<html>
          <head>
           <title>–≈√»—“–ј÷»я «јя¬ » Ќј —’≈ћ”</title>
            </head>
             <body>
              <p><b>” ¬ј— Ќќ¬јя «јя¬ ј Ќј —’≈ћ” :</b></p>
         <table>
          <tr>
