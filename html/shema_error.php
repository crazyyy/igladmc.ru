<?php 
//ПЕРЕХОД С ОБРАБОТЧИКА ОТПРАВКИ ПИСЬМА АДМИНУ ДЛЯ ФОРМЫ ЗАКАЗА СХЕМЫ - ЗАЯВКА НЕ ПРИНЯТА ПИСЬМО НЕ ОТПРАВЛЕНО
...
<title>Заказ схемы - ошибка</title>
 </head>
  <body>
   <div class="main">
   ...
   <div id='message'>
    <h2 style="color:red;">Заявка не отправлена !</h2>
     <p style="color:red;">Во время отправки данных произошла ошибка ! Пожалуйста, попробуйте заполнить заявку еще раз.</p>
      <br/>
      <p><a href="index.php#shema_zak">Вернуться к регистрации заявки...</a></p> 
